...
// 将网络图片存为临时图片
  shareFrends() {
    ...
    //   })
    // })
    // var post_cover ="https://wx.qlogo.cn/mmhead/Q3auHgzwzM4FiaDrQm3vcZkk0cMydCAic97apIn3jY0FKYsrYGcEyjeQ/0";
    let post_cover =  '../../imgs/post_cover.png';
    wx.getImageInfo({
      src: "https://wx.qlogo.cn/mmhead/Q3auHgzwzM4FiaDrQm3vcZkk0cMydCAic97apIn3jY0FKYsrYGcEyjeQ/0",
      success: res => {
        that.setData({
          avatar: res.path
        })
...
// canvas 生成图片
  ...
  shareTo() {
    ...
    this.setData({
      options: {
        showShareModal: true,
        shareModel: that.createShareModel()
      }
    });
  },
  createShareModel:function(){
    return{
      title: "辽大二部 新上房源 南北通透 全明户型 不临街 户口没问题 能落户",
      houseMemo:"4室2厅1卫 • 105㎡",
      price:"300万",
      area:"大东区-陶瓷城",
      name: "我是小神龙",
      erweima: "/imgs/mini.png",
      avator: "https://img76.517cdn.com//up2017/zy/userheadimg/viewimg/2017/11/4/uid48895_20171104172316534740.jpg.1911.204x153.3.jpg",                  cover:"https://img76.517cdn.com//up2017/zy/2018/12/7/house/viewimg/fid3027748_uid48895_20181207133718543650.jpg.1911.524x393.0.jpg",
      backImg:"https://a.58cdn.com.cn/weixin/img/wechat-app/shareToFriends/bg-house-property.png"
    }
  },
  hideModal() {
    this.setData({
